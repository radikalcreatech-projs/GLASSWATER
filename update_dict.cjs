...
content = content.replace(/'portal\.demo': '\*This is a demo\. In production, this will connect to your secure document storage\.',/, `'portal.demo': '*This is a demo. In production, this will connect to your secure document storage.',
...
content = content.replace(/'portal\.demo': '\*Ceci est une démo\. En production, cela sera connecté à votre stockage sécurisé de documents\.',/, `'portal.demo': '*Ceci est une démo. En production, cela sera connecté à votre stockage sécurisé de documents.',
