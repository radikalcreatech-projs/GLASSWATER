...
export function Footer() {
  ...
  return (
    <footer className="bg-navy text-light-gray pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-16">
        ...
        <div>
          ...
          <div className="space-y-4 text-light-gray/70 text-sm">
            <p className="flex items-center gap-3 hover:text-gold transition-colors cursor-pointer"><Phone size={18} className="text-gold" /> 0248284384</p>
            <p className="flex items-center gap-3 hover:text-gold transition-colors cursor-pointer"><Mail size={18} className="text-gold" /> glasswaterfits@gmail.com</p>
            <p className="flex items-start gap-3"><MapPin size={18} className="text-gold shrink-0 mt-0.5" /> <span className="leading-relaxed">Agbogba Junction, Abokobi,<br/>Accra, Ghana</span></p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            <a href="https://wa.me/2330248284384" target="_blank" rel="noreferrer" className="text-[#25D366] font-semibold hover:text-gold transition-colors flex items-center gap-2 uppercase tracking-widest text-xs">
              <MessageCircle size={16} /> WhatsApp
            </a>
            <a href="https://facebook.com/glasswater" target="_blank" rel="noreferrer" className="text-light-gray/70 hover:text-gold transition-colors uppercase tracking-widest text-xs">Facebook</a>
            <a href="https://instagram.com/glasswater" target="_blank" rel="noreferrer" className="text-light-gray/70 hover:text-gold transition-colors uppercase tracking-widest text-xs">Instagram</a>
            <a href="https://linkedin.com/company/glasswater" target="_blank" rel="noreferrer" className="text-light-gray/70 hover:text-gold transition-colors uppercase tracking-widest text-xs">LinkedIn</a>
          </div>
        </div>
      </div>
